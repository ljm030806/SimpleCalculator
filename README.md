...
-과제4코드의실행스크린샷![과제4 실행화면](img/screenshot13.png)
-연산자의 우선순위를 조정하여 계산이 정확하게 이루어지도록 개선. 예를 들어 2 + 3 * 4는 20이 아닌 14로 계산되도록 구현했습니다
-과제4코드의실행스크린샷![과제4 실행화면](img/screenshot14.png)
-괄호기능을 추가하여 연산 우선순위 조정했습니다